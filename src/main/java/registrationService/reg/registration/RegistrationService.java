package registrationService.reg.registration;

import java.time.LocalDateTime;
import lombok.AllArgsConstructor;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
import registrationService.reg.email.EmailSender;
...
import registrationService.reg.user.AppUserRole;
import registrationService.reg.user.AppUserService;
...
public class RegistrationService {
  ...
  public String register(RegistrationRequest request) {
    ...
    String token = appUserService.singUpUser(AppUser.builder()
  ...
  public String confirmToken(String token) {
    ...
    ConfirmationToken confirmationToken = confirmationServiceToken.getToken(token)
        .orElseThrow(() -> new IllegalArgumentException("wrong token"));

    if (confirmationToken.getConfirmedAt() != null) {
      throw new IllegalArgumentException("already confirmed email");
    }
